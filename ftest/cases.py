...
for result in imap_unordered(
    HOMEGENEOUS_DATA, sleeper, 10, key=itemgetter(0), parallelism=1
):
    print(result)
print()
...
for result in imap_unordered(
    BUFFER_SIZE_DATA, sleeper, 2, key=itemgetter(0), parallelism=1, buffer_size=3
):
    print(result)
print()
...
for result in imap_unordered(
    BUFFER_SIZE_DATA, sleeper, 10, key=itemgetter(0), parallelism=1, buffer_size=3
):
    print(result)
print()
...
for result in imap_unordered(
    BUFFER_SIZE_DATA, sleeper, 10, key=itemgetter(0), parallelism=3, buffer_size=3
):
    print(result)
print()
